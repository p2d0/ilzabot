...
mozhno_responses = 'можно телегу с разбегу;можно машку за ляжку и козу на возу;можно собачку под срачку;можно дядю Гришу через крышу;можно соседку через розетку;можно в углу поссать, козу обоссать'
mozhno_responses_list = mozhno_responses.split(';')
